...
var docID = window.prompt('Enter PO number to view in FY ' + getAY(),'XXXXXXX');

var oldURL = location.href.split('#')[0];
var newURL = 'https://eactivities.union.ic.ac.uk/finance/documents/' + centre + '#' + getAY() + '/Expenditure/Purchase%20Orders/Details/' + docID;
