...
var docID = window.prompt('Enter SI number to view in FY ' + getAY(),'XXXXXX');

var oldURL = location.href.split('#')[0];
var newURL = 'https://eactivities.union.ic.ac.uk/finance/documents/' + centre + '#' + getAY() + '/Income/Sales%20Invoices/Details/' + docID;
